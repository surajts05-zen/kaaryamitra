...
import { Calendar, Clock, Bell, CalendarDays, UserPlus, Headset, UserMinus, Activity, FileText, Megaphone, Laptop, ArrowRight, CalendarClock, Timer, Wallet, CreditCard, Target } from 'lucide-react';
...
const QUICK_LINKS = [
  ...
  { title: 'My Compensation', icon: Wallet, href: 'compensation', color: 'bg-green-500/10 text-green-600' },
  { title: 'My Payslips', icon: CreditCard, href: 'payslips', color: 'bg-blue-500/10 text-blue-600' },
