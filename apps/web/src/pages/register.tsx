...
export function RegisterPage() {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="hidden w-1/2 flex-col justify-between bg-sidebar p-12 text-sidebar-foreground lg:flex">
        ...
        <div className="space-y-6 max-w-md">
          ...
          <p className="text-lg text-sidebar-foreground/70">
            Create a workspace for your company in seconds. No credit card required.
          </p>
        </div>
      ...
      <div className="flex w-full flex-col justify-center px-8 py-12 sm:px-12 lg:w-1/2 overflow-y-auto">
